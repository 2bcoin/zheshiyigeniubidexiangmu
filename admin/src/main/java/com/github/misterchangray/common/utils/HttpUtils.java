...
public class HttpUtils {
    ...
    private static String apiKey = "BPTh9qWoh4Z2LEetACLnlxfIAIS2rrMubuqaCz7BgMqcrwVClVjS1ZmswEB2oPDm";
    private static String secretKey = "MnJ2VmezyxOf0gIY6qU6CKmeDEgE6HfeyijRi7SePVCWXWL9uqgEGYzdZMbVj0ts";
