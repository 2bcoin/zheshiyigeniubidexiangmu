...
import com.github.misterchangray.libs.binance.api.client.BinanceApiWebSocketClient;
import com.github.misterchangray.libs.binance.api.client.constant.BinanceApiConstants;
import com.github.misterchangray.libs.binance.api.client.domain.event.*;
...
public class BinanceApiWebSocketClientImpl implements BinanceApiWebSocketClient, Closeable {
    ...
    public Closeable onDepthEvent(String symbol, BinanceApiCallback<DepthEvent> callback) {
        final String channel = String.format("%s@depth20", symbol);
