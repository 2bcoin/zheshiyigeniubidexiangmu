...
public class OkCoinMarketDataServiceRaw extends OkCoinBaseService {
  ...
  public List<Object[]> getFutureKlines(CurrencyPair currencyPair, String type, String contract_type,  String size) throws IOException {
    return okCoin.getFutureKlines(OkCoinAdapters.adaptSymbol(currencyPair), type, contract_type, size);
  }
}
