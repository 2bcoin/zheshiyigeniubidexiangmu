...
public class HttpRequestParserUtils {
     ...
     * @return
     */
    public static String getOsAndBrowserInfo(HttpServletRequest httpServletRequest) {
        String browserDetails = HttpRequestParserUtils.getUserAgent(httpServletRequest);
