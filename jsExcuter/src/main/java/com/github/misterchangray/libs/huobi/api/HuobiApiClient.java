...
public class HuobiApiClient {
    ...
    /**
     * GET /market/depthSpot 获取 Market Depth 数据
     *
     * @param request
     * @return
     */
    public DepthResponse depth(DepthRequest request) {
        ...
        DepthResponse resp = get("/market/depthSpot", map, new TypeReference<DepthResponse<List<Depth>>>() {
        });
        return resp;
    }

    /**
     * GET /market/order 获取 Trade Detail 数据
     *
     * @param symbol
     * @return
     */
    public TradeResponse trade(String symbol) {
        HashMap map = new HashMap();
        map.put("symbol", symbol);
        TradeResponse resp = get("/market/order", map, new TypeReference<TradeResponse>() {
        });
        return resp;
    }

    /**
     * GET /market/history/order 批量获取最近的交易记录
     *
     * @param symbol
     * @param size
     * @return
    ...
    public HistoryTradeResponse historyTrade(String symbol, String size) {
        ...
        map.put("symbol", symbol);
        map.put("size", size);
        HistoryTradeResponse resp = get("/market/history/order", map, new TypeReference<HistoryTradeResponse>() {
        });
        return resp;
    }
