...
public class MongoPageHelper {
     ...
     * java.lang.String)
     */
    public <T> PageResult<T> pageQuery(Query query, Class<T> entityClass, String className, Integer pageSize,
                                       Integer pageNum) {
        return pageQuery(query, entityClass, className, Function.identity(), pageSize, pageNum, null);
    }
    ...
    public <T, R> PageResult<R> pageQuery(Query query, Class<T> entityClass, String className, Function<T, R> mapper,
        ...
        return pageQuery(query, entityClass, className, mapper, pageSize, pageNum, null);
    }
