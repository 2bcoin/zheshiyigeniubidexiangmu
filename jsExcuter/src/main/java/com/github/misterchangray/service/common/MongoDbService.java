...
public class MongoDbService {
     ...
     * @return
     */
    public <T> List<T> findList(Query q, String collectionName, Class<T> clazz ) {
        List<T> res = mongoTemplate.find(q, clazz, collectionName);
        return res;
    }
    ...
    public <T> List<T> list(String collectionName, Class<T> clazz) {
        return mongoTemplate.findAll(clazz, collectionName);
    }

    public <T> List<T> list(Query query, String collectionName, Class<T> clazz) {
